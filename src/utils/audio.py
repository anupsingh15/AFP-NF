...
if __name__ == "__main__":
    audioreader = Audio()
    data = audioreader.read("../data/LibriSpeech/train-clean-100/1081/128618/1081-128618-0005.flac")
    noise = audioreader.read("../data/noise_16k/Shopping.wav")
    rir = audioreader.read("../data/rir_16k/0.5.wav")
